...
<div class="modal fade" id="add_new_publi" tabindex="-1" style="display: none;" aria-hidden="true">
    <!--begin::Modal dialog-->
                    ...
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_new_address_scroll" data-kt-scroll="true"
                        ...
                        <div
                            ...
                            <div class="d-flex flex-stack flex-grow-1 ">
                                ...
                                <div class=" fw-semibold">
                                    ...
                                    <div class="fs-6 text-gray-700 ">Após esta etapa, você poderá adicionar mais
                                        detalhes a esta publicidade.</div>
                                </div>
                                <!--end::Content-->
                        ...
                        <div class="row mb-5">
                            <div class="col-md-12 fv-row fv-plugins-icon-container">
                                <label class="required fs-5 fw-semibold mb-2">Título da Publicidade</label>
                                <input type="text" class="form-control form-control-solid"
                                    placeholder="Ex.: Vídeos da nova coleção" name="title">
                            </div>
                        </div>
                        ...
                        <div class="row mb-5">
                            <div class="col-md-6 fv-row fv-plugins-icon-container">
                                ...
                                <div class="input-group input-group-solid mb-5">
                                    ...
                                    <input type="text" class="form-control" placeholder="Ex.: 800" name="price">
                                </div>
                                <div
                        ...
                        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                            ...
                            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                ...
                                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                    ...
                                    <li class="breadcrumb-item text-muted">Publicidades</li>
                                        ...
                                        <div class="card-header py-7">
                                            ...
                                            <div class="card-title pt-3 mb-0 gap-4 gap-lg-10 gap-xl-15 nav nav-tabs border-bottom-0"
                                                ...
                                                <div class="fs-4 fw-bold pb-3 border-bottom border-3 border-primary cursor-pointer"
                                                    data-kt-table-widget-3="tab"
                                                    data-kt-table-widget-3-value="Show All">
                                                    Todas as Publicidades ({{ $publis->count() }})
                                                </div>
                                                <!--end::Tab item-->
                                            </div>
                                            <!--end::Tabs-->
                                            ...
                                            <div class="card-toolbar">
                                                <a href="#" type="button" class="btn btn-primary"
                                                    data-bs-toggle="modal" data-bs-target="#add_new_publi">Nova
                                                    Publicidade</a>
                                            </div>
                                        ...
                                        <div class="card-body pt-1">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <div class="position-relative ps-6 pe-3 py-2">
                                                                            ...
                                                                            <a href="#"
                                                                                class="mb-1 text-gray-900 text-hover-primary fw-bold">{{ $publi->title }}</a>
                                                                            <div class="fs-7 text-muted fw-bold">Criada
                                                                                em
                                                                                {{ $publi->created_at->format('d/m/Y') }}</div>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <span
                                                                    ...
                                                                    <td>{{ $publi->company->name }}</td>
                                                                    <td>{{ Carbon\Carbon::parse($publi->deadline)->format('d/m/Y') }}</td>
                                                                    <td>
                                                                        <button type="button"
                                            ...
                                            @else
                                                <div class="d-flex flex-column align-items-center text-center py-10">
                                                    ...
                                                    <h3 class="text-gray-900 fw-bold mb-2">Nenhuma publicidade encontrada</h3>
                                                </div>
                                            @endif
                                        </div>
